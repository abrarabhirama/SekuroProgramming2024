...
(cl:defmethod cl:initialize-instance :after ((m <Pesan>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pesan)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name demo_pkg-msg:<Pesan> is deprecated: use demo_pkg-msg:Pesan instead.")))

(cl:ensure-generic-function 'usia-val :lambda-list '(m))
(cl:defmethod usia-val ((m <Pesan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo_pkg-msg:usia-val is deprecated.  Use demo_pkg-msg:usia instead.")
  (usia m))

(cl:ensure-generic-function 'tinggi-val :lambda-list '(m))
(cl:defmethod tinggi-val ((m <Pesan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo_pkg-msg:tinggi-val is deprecated.  Use demo_pkg-msg:tinggi instead.")
  (tinggi m))

(cl:ensure-generic-function 'nama-val :lambda-list '(m))
(cl:defmethod nama-val ((m <Pesan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo_pkg-msg:nama-val is deprecated.  Use demo_pkg-msg:nama instead.")
  (nama m))

(cl:ensure-generic-function 'kehadiran-val :lambda-list '(m))
(cl:defmethod kehadiran-val ((m <Pesan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader demo_pkg-msg:kehadiran-val is deprecated.  Use demo_pkg-msg:kehadiran instead.")
  (kehadiran m))
